                                ...
                                <nav class="flex flex-wrap items-center">
                                    <ul
                                        ...
                                        <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                            <a href="{{ url('/') }}"
                                                class="transition-all hover:text-secondary">Home</a>
                                        </li>
                                        <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                            <a href="{{ url('/About-Us') }}"
                                                class="transition-all hover:text-secondary">About</a>
                                        </li>
                                        <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                            <a href="#" class="transition-all hover:text-secondary">Projests</a>
                                            <ul
                                                class="list-none bg-white drop-shadow-[0px_6px_10px_rgba(0,0,0,0.2)] rounded-[12px] flex flex-wrap flex-col w-[220px] absolute top-[120%] left-1/2 -translate-x-1/2 transition-all group-hover:top-[100%] invisible group-hover:visible opacity-0 group-hover:opacity-100">
                                                <li
                                                    class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                    <a href="{{ url('/LaVistaHomes') }}"
                                                        class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-t-[12px]">La
                                                        Vista Homes</a>
                                                </li>
                                                <li
                                                    class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                        ...
                                        <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                            <a href="{{ url('/Services') }}"
                                                class="transition-all hover:text-secondary">Service's</a>
                                        </li>
                                        <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                            <a href="{{ url('/Contact-Us') }}"
                                                class="transition-all hover:text-secondary">Contact</a>
                                        </li>
                                    </ul>
                                    </li>
                ...
                <nav class="offcanvas-menu mr-[20px]">
                    <ul>
                        ...
                        <li class="relative block border-b-primary border-b"><a href="#"
                                class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">Projects</a>
                        ...
                        <li class="relative block border-b-primary border-b"><a href="{{ url('/Services') }}"
