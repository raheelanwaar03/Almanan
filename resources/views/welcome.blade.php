...
<body class="font-karla text-body text-tiny">
    <div class="overflow-hidden">
                                ...
                                <div class="grid grid-cols-12">
                                    <div class="col-span-12 lg:col-span-5 xl:col-span-6">
                                        <div class="slider-content max-w-[560px] relative z-[9]">
                                            <div class="relative mb-5 sub_title">
                                                <span class="text-base text-white block">A new way to find
                                                    Properties</span>
                                            </div>
                                            <h1
                                    ...
                                    <div class="col-span-12 lg:col-span-7 xl:col-span-6">
                                        <div
                                            ...
                                            <img class="hero_image w-full" src="assets/images/hero/home-1.png"
                                                width="866" height="879" alt="hero image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="properties-details.html"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">MODERN
                                                VILLAS.</a></h3>
                                        <h4><a href="properties-details.html"
                                                class="font-light text-[14px] leading-[1.75] underline">194 Mercer
                    ...
                    <div class="col-span-12 flex flex-wrap flex-col md:flex-row items-start justify-between mb-[50px]">
                        ...
                        <ul class="all-properties flex flex-wrap lg:pt-[10px]">
                            <li data-tab="all-properties"
                                class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none active"><button
                            ...
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties4.jpg"
                                        ...
                                        <div class="py-[20px] px-[20px] text-left">
                                            ...
                                            <h4><a href="properties-details.html"
                                                    class="font-light text-[14px] leading-[1.75] underline"></a></h4>
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties5.jpg"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties6.png"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                                                    alt="Duplex de Villa.">
                                            </a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties7.png"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                                                    alt="Orchid Modern Properties.">
                                            </a>
                                        </div>
                                        ...
                                        <div class="py-[20px] px-[20px] text-left">
                                            <h3><a href="properties-details.html"
                                                    ...
                                                    Modern Properties.</a></h3>
                                            <h4><a href="properties-details.html"
                                                    class="font-light text-[14px] leading-[1.75] underline">2846 West
                                                    Side Avenue, New Jersey</a></h4>
                                            <span class="font-light text-sm">Added: 25 November, 2021</span>
                                            <ul
                                                class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                                <li
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties8.jpg"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                                        ...
                                        <div class="py-[20px] px-[20px] text-left">
                                            <h3><a href="properties-details.html"
                                                    ...
                                                    de parlosia.</a></h3>
                                            <h4><a href="properties-details.html"
                                                    class="font-light text-[14px] leading-[1.75] underline">2381
                                                    Richards Avenue, Stockton, California</a></h4>
                                            <span class="font-light text-sm">Added: 25 November, 2021</span>
                                            <ul
                                                class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                                <li
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties9.jpg"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                            ...
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties1.png"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                                                    alt="Elite Garden Resedence.">
                                            </a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties3.png"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                                                    alt="De Parasiya Appartment.">
                                            </a>
                                        </div>
                            ...
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="swiper-slide">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a href="properties-details.html" class="block">
                                                <img src="assets/images/properties/properties2.png"
                                                    class="w-full h-full" loading="lazy" width="370" height="266"
                                                    alt="Sinomen Studio Palace.">
                                            </a>
                ...
                <div
                    ...
                    <div class="col-span-12 lg:col-span-6 text-center">
                        <div class="relative rounded-[24px] lg:pt-[45px] lg:pr-[45px] z-[1] lg:inline-block">
                            <div class="">
                                <img src="assets/images/video/shape-3.png"
                                    class="absolute top-[30px] right-[30px] z-[-1]" loading="lazy" width="50"
                                    height="60" alt="shape image">
                                <img src="assets/images/video/shape-2.png"
                                    class="absolute left-1/2 hidden lg:block lg:bottom-5 lg:-left-[160px]"
                                    loading="lazy" width="128" height="56" alt="Shape">
                            </div>
            ...
            " aria-label="play button">
                ...
                <div class="flex flex-row items-baseline gap-2 mt-10 leading-[1]">
                    <span class="text-secondary text-[16px] sm:text-[20px] font-lora font-normal">Have a
                        question?</span>
                    <a class="text-primary text-[22px] sm:text-[28px] font-lora font-medium" href="tel:+01234874854">
                        0304 1119333</a>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="grid sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-x-5 md:gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html">
                                <img src="assets/images/team/person1.jpg" class="w-auto h-auto block mx-auto"
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html">
                                <img src="assets/images/team/person3.jpg" class="w-auto h-auto block mx-auto"
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html">
                                <img src="assets/images/team/team.jpg" class="w-auto h-auto block mx-auto"
        ...
        <!-- Blog Section Start  -->
        <section class="properties-grids-section pt-[80px] pb-[120px] lg:py-[120px]">
            <div class="container">
            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
                    <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                        ...
                        <p class="mb-[5px] xl:mb-[40px] max-w-[270px]">Al-Mannan Builders has been developing, selling
                            and managing the finest property investments.</p>
                    </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
                        ...
                        <p>
                            Email:info@almannanbuilders.com
                        </p>
