                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="py-[20px] px-[20px] text-left">
                                    <h3><a href="#"
                                            class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">Almannan Spanish Villas.</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="py-[20px] px-[20px] text-left">
                                    <h3><a href="#"
                                            class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">Green City Executive I-II-III.</a></h3>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div
                                        ...
                                        <ul>
                                            <li class="flex flex-wrap items-center justify-between mt-4">
                                                <span
                                                    class="font-lora text-[18px] leading-none capitalize text-secondary">Ayesha
                                                    Khan</span>
